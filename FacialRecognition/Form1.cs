...
namespace FacialRecognition
{
    public partial class Form1 : Form
    {
        ...
        CascadeClassifier faceCasacdeClassifier = new CascadeClassifier(@"D:\Proj\FacialRecognition\FacialRecognition\haarcascade_frontalface_alt.xml");
        ...
        public Form1()
        {
            ...
            btnDetect.Click += btnDetectFaces_Click;
            btnStop.Click += btnStopCapture_Click;
        }
                        ...
                        foreach (var face in faces)
                        {
                            ...
                            if (EnableSaveImage)
                            {
                                ...
                                Task.Factory.StartNew(() => {
                                    for (int i = 0; i < 10; i++)
                                    {
                                        resultImage.Resize(200, 200, Inter.Cubic).Save(path + @"\" + txtPersonName.Text 
